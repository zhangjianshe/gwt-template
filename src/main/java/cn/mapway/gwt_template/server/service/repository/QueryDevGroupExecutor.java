...
import cn.mapway.gwt_template.shared.rpc.repository.QueryDevGroupRequest;
import cn.mapway.gwt_template.shared.rpc.repository.QueryDevGroupResponse;
...
public class QueryDevGroupExecutor extends AbstractBizExecutor<QueryDevGroupResponse, QueryDevGroupRequest> {
    ...
    protected BizResult<QueryDevGroupResponse> process(BizContext context, BizRequest<QueryDevGroupRequest> bizParam) {
        ...
        response.setGroups(repositoryService.userGroups(user.getUser().getUserId()));
