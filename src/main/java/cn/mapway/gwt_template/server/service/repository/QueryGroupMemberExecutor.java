...
import cn.mapway.gwt_template.shared.rpc.repository.QueryGroupMemberRequest;
import cn.mapway.gwt_template.shared.rpc.repository.QueryGroupMemberResponse;
...
public class QueryGroupMemberExecutor extends AbstractBizExecutor<QueryGroupMemberResponse, QueryGroupMemberRequest> {
    ...
    protected BizResult<QueryGroupMemberResponse> process(BizContext context, BizRequest<QueryGroupMemberRequest> bizParam) {
        ...
        DevGroupMemberEntity member = repositoryService.findGroupMemberByMemberId(request.getGroupName(), user.getUser().getUserId());
