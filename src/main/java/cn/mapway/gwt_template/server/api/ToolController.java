...
public class ToolController extends ApiBaseController {
     ...
     * @return data
     */
    @Doc(value = "QueryImages", retClazz = {QueryImagesResponse.class})
    @RequestMapping(value = "/queryImages", method = RequestMethod.POST)
    public RpcResult<QueryImagesResponse> queryImages(@RequestBody QueryImagesRequest request) {
