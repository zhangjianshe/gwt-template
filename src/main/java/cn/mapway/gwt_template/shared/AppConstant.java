...
public class AppConstant {
    ...
    public static final String ROLE_SAVE_PUBLIC_HOST="ROLE_SAVE_PUBLIC_HOST";//公共主机保存
    ...
    public static final String UPLOAD_DOCKER_APP_RESOURCE = "docker_app_resource:";
