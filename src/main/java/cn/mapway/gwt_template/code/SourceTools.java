...
public class SourceTools {
    public static void main(String[] args) {
        ...
        String packageBean = "cn.mapway.gwt_template.shared.rpc.project.res";
        String packageService = "cn.mapway.gwt_template.server.service.project.res";
        ArrayList<String> methods = Lang.list(
                "addResourceMember","deleteResourceMember"
        );
